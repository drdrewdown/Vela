...
describe('NativeRenderer.getConfig — defaults resolve to concrete values', () => {
    it('emits a complete, versioned document from the dark theme', () => {
        ...
        expect(cfg.priceScale).toEqual({ mode: 'price', log: false, invert: false, borderColor: '#161d2b', labelsVisible: true, currentPriceLine: true, priceLabel: true, countdown: true, animateLastPrice: false });
